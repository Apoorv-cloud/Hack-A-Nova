...
public class MessageMainActivity extends AppCompatActivity {
    ...
    private void updateLocation(Location location) {
        ...
        if (haveLocation) {
            ...
            detailsText.setText(String.format("Help Me %s: %s%s%s: %s (%s)%s%s: %s (%s)",
    ...
    public class onClickShareListener implements OnClickListener {
        @Override
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.action_settings:
                Intent intentSettingsActivity = new Intent(this, SettingsMainsActivity.class);
